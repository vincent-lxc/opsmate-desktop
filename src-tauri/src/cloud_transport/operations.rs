...
pub const OPERATIONS_CONTENT_HASH: &str = "9dede4bcef2407d7";
...
pub fn spec(op: Operation) -> OperationSpec {
    match op {
        ...
        Operation::ServersHostKey => OperationSpec {
            id: "servers.host_key",
            method: Method::Post,
            path: "/api/servers/{id}/host-key",
            authenticated: true,
            path_params: &["id"],
            query_fields: &[],
            body_fields: &["expected_fingerprint", "host_key_type", "fingerprint"],
            fixed_body_fields: &[],
            availability: Availability::Available,
            invocation: Invocation::NativeOnly,
        },
...
pub fn from_id(id: &str) -> Option<Operation> {
    match id {
            ...
            "servers.host_key" => Some(Operation::ServersHostKey),
...
mod operations_tests {
    ...
    fn all_operations_round_trip_and_have_allowlists() {
        assert_eq!(ALL_OPERATIONS.len(), 25);
