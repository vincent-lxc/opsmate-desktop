#!/usr/bin/env node
/**
 * Deterministically generate Rust Operation allowlist + OpenAPI snapshot from
 * contracts/desktop-operations.json (single source of truth).
 *
 * Usage:
 *   node scripts/generate-operations.mjs           # write rust + openapi
...
function main() {
  ...
  if (check) {
    ...
    console.log(
      "contracts:check ok — operations.rs and openapi-v1.yaml match desktop-operations.json",
    );
    return;
  }
